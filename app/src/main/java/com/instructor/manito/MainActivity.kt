...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(bind) {
            ...
            // 내가 들어간 방 어댑터 연결
            mainManitoRoomRecycler.layoutManager = LinearLayoutManager(this@MainActivity, LinearLayoutManager.HORIZONTAL, false)
    ...
    override fun onStart() {
        ...
        with (bind) {
            ...
            roomList.clear()
            myRoomList.clear()
            Database.getReference("users/${Authentication.uid}/rooms") .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
